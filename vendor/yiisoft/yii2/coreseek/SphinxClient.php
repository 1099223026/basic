...
class SphinxClient
{
	...
	{
		assert ( $mode==SPH_MATCH_ALL // 匹配所有查询分词(默认模式)
			|| $mode==SPH_MATCH_ANY // 这个模式匹配任意一个词
			|| $mode==SPH_MATCH_PHRASE //  将整个查询看作一个词组，要求按顺序完整匹配
			|| $mode==SPH_MATCH_BOOLEAN // 将查询看作一个布尔表达式, 可以简单的与或非运算
