...
<!--                    <input type="text" class="form-control mgnb-20" placeholder="邮箱">-->
<!--                    这里不能定义邮箱id密码也是一样，一旦定义就不会出现错误验证-->
...
<!--                        = Html::submitButton( '登 录', ['class'=>'btn btn-danger btn-block btn-lg mgnb-20', 'id'=>'login-btn','name' =>'submit-button' ]); -->
...
<!--                        <img  src="" alt="">-->
<!--                        <a class="mgnl-5 inline-block" href="#"><span class="glyphicon glyphicon-refresh"></span></a>-->
<!--                    </div>-->
...
<!--                        弹出新窗口-->
                        ...
                        <div class="third-logo pull-left">
                            <a href="javascript:openNewWin('/vendor/yiisoft/yii2-authclient-custom/wb/wblogin.php',
                             '微博登录')">
                                <img id="wb_logo" src="img/wb_logo.png" alt="">
                            </a>
                        </div>
                        <div class="third-logo pull-left">
                            <a href="javascript:openNewWin('/vendor/yiisoft/yii2-authclient-custom/qq/qqlogin.php',
                             'QQ登录')" target="_blank">
